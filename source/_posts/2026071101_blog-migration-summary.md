...
> 凡是过往，皆为序章。6年前的旧博客已无法重新书写，借助AI大模型（opencode + deepseek v4 pro），索性新开一个博客，各项配置都变得简单了起来。本文内容就是与AI交流如何重建博客的对话，经AI总结整理之后的结果。在AI时代下，程序员的工作方式和习惯、用人单位对于岗位的要求等等，都在发生巨大的变化。希望在AI的帮助下，适应和跟上这个时代，重拾积累知识的习惯，努力充实自己，争取早日跳槽。加油～
